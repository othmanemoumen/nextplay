<!-- Your AdBleuMedia Content Locker Script -->
<script type="text/javascript">
    var pPogz_Jcb_xxpeNc = {"it": 4497260, "key": "06b27"};
</script>
<script src="https://d2yc6hxtq0phup.cloudfront.net/ea2a49d.js"></script>

<!-- Your Download Simulation Code -->
<script type="text/javascript">
    // Get elements
    ...
    function simulateDownload() {
        ...
        const interval = setInterval(() => {
            ...
            if (progress >= 100) {
                ...
                setTimeout(() => {
                    // Remove any previous locker scripts (optional cleanup)
                    document.querySelectorAll('script[src*="cloudfront.net"]').forEach(el => el.remove());

                    // Inject locker config
                    const lockerConfig = document.createElement("script");
